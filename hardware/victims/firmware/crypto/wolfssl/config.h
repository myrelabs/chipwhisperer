...
#define LIBWOLFSSL_CONFIGURE_ARGS " '--host=arm-none-eabi' 'CC=arm-none-eabi-gcc' 'LD=arm-none-eabi-ld' 'AR=arm-none-eabi-ar' 'RANLIB=arm-none-eabi-ranlib' 'CFLAGS=-DNO_WOLFSSL_DIR -DWOLFSSL_USER_IO -DNO_WRITEV  -mcpu=cortex-m4 -mthumb -Os  -specs=rdimon.specs' 'CPPFLAGS=-I./' 'host_alias=arm-none-eabi'"

#define LIBWOLFSSL_GLOBAL_CFLAGS "-I./  -DNO_WOLFSSL_DIR -DWOLFSSL_USER_IO -DNO_WRITEV  -mcpu=cortex-m4 -mthumb -Os  -specs=rdimon.specs   -Wno-pragmas -Wall -Wno-strict-aliasing -Wextra -Wunknown-pragmas --param=ssp-buffer-size=1 -Waddress -Warray-bounds -Wbad-function-cast -Wchar-subscripts -Wcomment -Wfloat-equal -Wformat-security -Wformat=2 -Wmaybe-uninitialized -Wmissing-field-initializers -Wmissing-noreturn -Wmissing-prototypes -Wnested-externs -Wnormalized=id -Woverride-init -Wpointer-arith -Wpointer-sign -Wredundant-decls -Wshadow -Wsign-compare -Wstrict-overflow=1 -Wswitch-enum -Wundef -Wunused -Wunused-result -Wunused-variable -Wwrite-strings -fwrapv -DWOLFSSL_TLS13 -DHAVE_TLS_EXTENSIONS -DHAVE_SUPPORTED_CURVES -DHAVE_FFDHE_2048 -DSINGLE_THREADED  -fvisibility=hidden -DHAVE_THREAD_LS -DNDEBUG -DTFM_TIMING_RESISTANT -DECC_TIMING_RESISTANT -DWC_RSA_BLINDING -DWOLFSSL_SHA512 -DWOLFSSL_SHA384 -DHAVE_HKDF -DNO_DSA -DHAVE_ECC -DTFM_ECC256 -DECC_SHAMIR -DWC_RSA_PSS -DNO_RC4 -DNO_HC128 -DNO_RABBIT -DHAVE_POLY1305 -DHAVE_ONE_TIME_AUTH -DHAVE_CHACHA -DHAVE_HASHDRBG -DHAVE_TLS_EXTENSIONS -DHAVE_SUPPORTED_CURVES -DHAVE_EXTENDED_MASTER -DNO_RC4 -DHAVE_ENCRYPT_THEN_MAC -DNO_PSK -DNO_MD4 -DNO_PWDBASED -DWC_NO_ASYNC_THREADING -DHAVE_DH_DEFAULT_PARAMS -DNO_DES3 -DGCM_TABLE_4BIT -DHAVE_AESGCM -Wall -Wno-unused -Os -DHAVE_WC_INTROSPECTION"
